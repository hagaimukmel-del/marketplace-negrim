...
export default async function SuppliersPage() {
  const { data } = await getSupabaseAdmin()
    ...
    .select(
      'id, company_name, business_id, contact_name, phone, email, city, address, pickup_address, min_order_value_excl_vat, default_lead_time_days, sells_note, logo_url, token, status, source, created_at, decided_at'
    )
